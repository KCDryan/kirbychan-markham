...
The blog writer takes the first unticked topic on each run (see `BLOG-PLAYBOOK.md`, section 3).
Format: `- [ ] Working title | category | primary keyword`. When a topic is published, tick it and
add the slug. New ideas go at the bottom.
...
- [ ] Ontario's non-resident speculation tax and the foreign buyer ban | buying | non resident speculation tax ontario
- [ ] Home insurance basics for a Markham home | buying | home insurance ontario
- [ ] Building permits in Markham for renovations | selling | markham building permit
